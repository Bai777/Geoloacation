...
import com.example.geoloacation.databinding.MainFragmentLayoutBinding
...
abstract class BaseMainFragment: Fragment(), UserLocationObjectListener {
    ...
    private val listener = object : InputListener {
        override fun onMapTap(p0: Map, p1: Point) {
            addMarker(p1.latitude, p1.longitude, R.drawable.ic_menu_add, )
        }
    ...
    override fun onObjectAdded(userLocationView: UserLocationView) {
        ...
        userLocationView.arrow.setIcon(
            ImageProvider.fromResource(
                requireContext(), R.drawable.ic_dialog_alert
            )
        )
        ...
        pinIcon.setIcon(
            "icon",
            ImageProvider.fromResource(requireContext(), R.drawable.ic_dialog_email),
